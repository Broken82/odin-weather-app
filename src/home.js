...
export function homePage(){
    ...
    Welcome to Szefa's Rollos, fill your mouth with delicious
    sosa with tender kraft meat!`

    const secondParagraph = document.createElement('p')
    
    secondParagraph.innerHTML = `
    All you ever had been needing will be fullfild here
    `
    ...
    content.append(firstParagraph);
    content.append(secondParagraph);
